...
_channel = logging.FileHandler('/fsx/sashaluc/logs/fillmask_testing_oscar.log')
...
for model in fillmask_models:
    print(model)
    tracker = EmissionsTracker(project_name=model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/fillmask_oscar.csv')
    tracker.start()
