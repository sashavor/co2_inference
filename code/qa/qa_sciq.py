...
_channel = logging.FileHandler('/fsx/sashaluc/logs/qa_sciq.log')
...
for model in qa_models:
    print(model)
    tracker = EmissionsTracker(project_name=model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/qa_sciq.csv')
    tracker.start()
