...
_channel = logging.FileHandler('/fsx/sashaluc/logs/text_classif_imdb.log')
...
for model in text_classif_models:
    print(model)
    tracker = EmissionsTracker(project_name=model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/text_classif_imdb.csv')
    tracker.start()
