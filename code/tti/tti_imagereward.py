...
_channel = logging.FileHandler('/fsx/sashaluc/logs/tti_testing_imagereward.log')
...
def dset_gen():
    dset = load_dataset("THUDM/ImageRewardDB", "1k", streaming=True, split="train")
...
for tti_model in tti_models:
    print(tti_model)
    tracker = EmissionsTracker(project_name=tti_model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/tti_imagereward.csv')
    tracker.start()
