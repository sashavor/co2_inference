...
_channel = logging.FileHandler('/fsx/sashaluc/logs/itt_testing_visualgenome.log')
...
for itt_model in itt_models:
    print(itt_model)
    tracker = EmissionsTracker(project_name=itt_model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/itt_visualgenome_git.csv')
    tracker.start()
