...
_channel = logging.FileHandler('/fsx/sashaluc/logs/textgen_testing_bookcorpus.log')
...
for tg_model in text_gen_models:
    print(tg_model)
    tracker = EmissionsTracker(project_name=tg_model, measure_power_secs=1, logging_logger=_logger, output_file='/fsx/sashaluc/emissions/textgen_bookcorpus.csv')
    tracker.start()
